<template>
    <div class="bottom-bar">
        <keep-alive>
            <router-view v-transition class="router-wrap"/>
        </keep-alive>
        <van-tabbar route safe-area-inset-bottom inactive-color="#A8B8C7" active-color="#1890FF" v-model="active" van-hairline--top>
            <van-tabbar-item route to="/home" replace name="home">
                <span>券码生成</span>
                <img
                  slot="icon"
                  slot-scope="props"
            ...
            <van-tabbar-item route to="/hexiao" replace name="hexiao">
                <span>核销</span>
                <img
                  slot="icon"
                  slot-scope="props"
            ...
            <van-tabbar-item route to="/my" replace name="my">
                <span>我的</span>
                <img
                  slot="icon"
                  slot-scope="props"
